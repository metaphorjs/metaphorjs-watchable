'use strict';define("metaphorjs-watchable",["metaphorjs-observable"],function(I){function s(b){return"object"==typeof b&&5===q(b)}function u(b){return"function"==typeof b}function t(b){return"string"==typeof b||b===""+b}function w(){}function x(b){return b===window||b&&b.document&&b.location&&b.alert&&b.setInterval}function v(b){return"object"==typeof b&&3===q(b)&&!b.nodeType&&b.constructor===Object}function J(b,m,d,f){setTimeout(function(){b.apply(m,d||[])},f||0)}function y(b){var m=b.stack||Error().stack;
if("undefined"!=typeof console&&console.log)J(function(){console.log(b);m&&console.log(m)});else throw b;}function B(b){return!0===b||!1===b}function z(b){b=q(b);return 3>b&&-1<b}function K(){return!1}var C=function(){var b=["0","0","0"];return function(){for(var m=b.length,d;m;){m--;d=b[m].charCodeAt(0);if(57==d)return b[m]="A",b.join("");if(90==d)b[m]="0";else return b[m]=String.fromCharCode(d+1),b.join("")}b.unshift("0");return b.join("")}}(),L=Object.prototype.toString,q=function(){var b={"[object String]":0,
"[object Number]":1,"[object Boolean]":2,"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(m){if(!m){if(null===m)return 6;if(void 0===m)return 7}var d=b[L.call(m)];return void 0===d?-1:1==d&&isNaN(m)?8:d}}(),r=function(){return String.prototype.trim?function(b){return t(b)?b.trim():b}:function(b){return t(b)?b.replace(/^\s\s*/,"").replace(/\s\s*$/,""):b}}(),D=Array.prototype.slice,E=function(){return function m(d,f){if(d===f)return!0;
if(null===d||null===f)return!1;if(d!==d&&f!==f)return!0;var h=typeof d,g;if(h==typeof f&&"object"==h)if(s(d)){if(!s(f))return!1;if((h=d.length)==f.length){for(g=0;g<h;g++)if(!m(d[g],f[g]))return!1;return!0}}else{if(10===q(d))return 10===q(f)&&d.getTime()==f.getTime();if(9===q(d)&&9===q(f))return d.toString()==f.toString();if(x(d)||x(f)||s(f))return!1;h={};for(g in d)if("$"!=g.charAt(0)&&!u(d[g])){if(!m(d[g],f[g]))return!1;h[g]=!0}for(g in f)if(!h.hasOwnProperty(g)&&"$"!=g.charAt(0)&&void 0!==f[g]&&
!u(f[g]))return!1;return!0}return!1}}(),F=function(){return function m(d,f){if(x(d))throw Error("Cannot copy window object");if(f){if(d===f)throw Error("Objects are identical");if(s(d))for(var h=f.length=0,g=d.length;h<g;h++)f.push(m(d[h]));else{for(h in f)delete f[h];for(h in d)d.hasOwnProperty(h)&&("$"==h.charAt(0)||u(d[h])?f[h]=d[h]:f[h]=m(d[h]))}}else(f=d)&&(s(d)?f=m(d,[]):10===q(d)?f=new Date(d.getTime()):9===q(d)?f=new RegExp(d.source):v(d)&&(f=m(d,{})));return f}}(),M=function(){return function m(){var d=
...
d)}},f={},h=0,g={},n=0,a={},e=0,c=function(){1E3<=h&&(f={});1E3<=n&&(g={});1E3<=e&&(a={})};return{createGetter:function(a){try{return f[a]?f[a]:(h++,f[a]=d(new m("____","$$interceptor","$$itself","".concat("try {","return ",a.replace(b,"$1____.$3"),";} catch (thrownError) { return undefined; }")),!0))}catch(e){return y(e),w}},createSetter:function(a){try{if(!g[a]){n++;var e=a.replace(b,"$1____.$3");return g[a]=d(new m("____","$$$$","$$interceptor","$$itself","".concat("try {",e," = $$$$",";} catch (thrownError) { return undefined; }")))}return g[a]}catch(c){return y(c),
w}},createFunc:function(c){try{return a[c]?a[c]:(e++,a[c]=d(new m("____","$$interceptor","$$itself","".concat("try {",c.replace(b,"$1____.$3"),";} catch (thrownError) { return undefined; }"))))}catch(f){return y(f),w}},resetCache:c,enableResetCacheInterval:function(){setTimeout(c,1E4)}}}(),H=G.createGetter,O=G.createSetter;return function(){var b=Object.observe&&N(Object.observe),m=function(a){if(!t(a))return!0;var e=a.substr(0,1),c=a.length-1;return'"'!=e&&"'"!=e||a.indexOf(e,1)!=c?!1:a.substring(1,
